...
To use (and install) this code, copy the git address (https://github.com/thebigg73/DyslexaTablet.git). Open Android Studio and select File > New > Project from Version Control. Paste in the git address. You can then run on an emulator or plugged in Android device as appropriate.
