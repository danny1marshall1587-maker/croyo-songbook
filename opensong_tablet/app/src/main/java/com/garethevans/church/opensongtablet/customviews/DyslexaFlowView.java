...
/**
 * DyslexaFlowView: An animated background view for Dyslexia accessibility.
 * Renders soft, moving patterns to reduce visual stress.
 */
public class DyslexaFlowView extends View {
    ...
    public DyslexaFlowView(Context context) {
        super(context);
        init();
    }

    public DyslexaFlowView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
