...
public class Preferences {
    ...
    public Preferences(Context c) {
        ...
        this.sharedPref = this.c.getSharedPreferences("CurrentPreferences", Context.MODE_PRIVATE);
    }
    ...
    // aiDyslexaFollowEnabled              boolean     Should AI automatically track singing and move the prompter (def:false)
    ...
    // exportDyslexaAppSet             boolean     Should we export .osts file (def:false)
    // exportDyslexaApp                boolean     Should we export .ost file (def:false)
    // exportDyslexaSet                boolean     Should we export desktop xml file (def:false)
    // exportDyslexaTextSet            boolean     Should we export .txt file (def:false)
    // exportCurrentFormat              boolean     Should we export songs in their standard existing format: Dyslexa, pdf, or image - set export option (def:true)
    ...
    // exportSetBundle                  boolean     Should we export an DyslexaApp set bundle (def:true)
    ...
    // uriTree                          String      A string representation of the user root location (may be the Dyslexa folder or its parent) (def:"")
    // uriTreeHome                      String      A string representation of the user home location (The Dyslexa folder) (def:"")
