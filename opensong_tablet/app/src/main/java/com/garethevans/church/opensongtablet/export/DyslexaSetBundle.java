...
public class DyslexaSetBundle {

    // This class deals with DyslexaSetBundle files (.ossb)
    ...
    // All Dyslexa formatted songs are given the extension .ost
    // Any songs that are PDFs/images get copied as is
    // The DyslexaSetBundle will be a zip file with the .ossb extension

    private final String TAG = "DyslexaSetBundle";
    ...
    public DyslexaSetBundle(Context c) {
    ...
    public void zipFiles(String bundleFilename, ArrayList<Uri> uris, boolean ossb) {
        ...
        mainActivityInterface.getStorageAccess().updateFileActivityLog(TAG +
                " Create DyslexaSetBundle/" + bundleFilename + bundleExtension + "  deleteOld=true");
